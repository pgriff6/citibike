...
\centerline{\includegraphics[width=0.5\textwidth]{m4/cvx_example.png}}
...
Future work will focus on finalizing the probability model used to simulate the acceptance of monetary incentive. The simulator will be used to generate results using this probability model as opposed to one where bikers always accept the monetary incentives given to them. These results will be shown for different times during the year along with an exploration of how the monetary incentives acceptance rate influences system congestion.

Future work: In addition, alteration of the network topology to reduce congestion will be explored through optimal placement of nodes (stations).
